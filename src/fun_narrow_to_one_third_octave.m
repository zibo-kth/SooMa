...
function [one_third_freq_preferred,bands] = fun_narrow_to_one_third_octave(frequencies,measurements)
...
%   figure
%   set(gca,'FontSize',16)
%   semilogx(frequencies,measurements,'k-','linewidth',0.6)
%   hold on
%   semilogx(one_third_freq_preferred,bands,'-ro','linewidth',2,'MarkerSize',8)
%   xlabel('Frequency (Hz)')
%   xlim([100 3000])
%   ylim([0 80])
